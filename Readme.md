...
# Configuration Script – CSST - Rev. B

This **Configuration** script is designed for the **CSST** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – CSST Rev. B

Este script de **Configuration** está diseñado para el modelo **CSST** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
